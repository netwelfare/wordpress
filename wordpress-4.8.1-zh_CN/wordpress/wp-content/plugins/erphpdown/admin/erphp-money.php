...
if(isset($_POST['Submit'])) {
	...
	/*if($getinfo)
	{
		echo '<div class="updated settings-error"><p>您已经申请提现，请等待管理员处理！</p></div>';
	}
	...
	{
		echo '<div class="updated settings-error"><p>您好，7天内只能申请一次提现！上次申请提现时间：'.$check7day->ice_time.'</p></div>';
	}*/
