...
<div class="wrap">
   ...
   // echo $user_info->ID;
    if ($_POST['check_money']){
     ...
     //$total_add=$wpdb->get_var("SELECT COUNT(ice_id) FROM $wpdb->icemoney WHERE ice_success>0 and ice_user_id=".$user_info->ID);
     //echo $total_add;
       // $adds=$wpdb->get_results("SELECT * FROM $wpdb->icemoney WHERE ice_success>0 and ice_user_id=".$user_info->ID);
