...
//微博及订阅设置
	...
	array( "type" => "open"),
       ...
       array("name" => "输入RSS订阅提示语",
            ...
            "id" => $shortname."_rss",
            "type" => "textarea",
            "std" => "Hi! 我是木秀林，欢迎光临我的博客，赶快订阅一下吧O(∩_∩)O~"),
...
//广告设置
	...
	array(	"name" => "输入首页(上)广告代码",
            ...
            "id" => $shortname."_top_c",
            "type" => "textarea",
            "std" => '<a href="http://www.muxiulin.com/" target="_blank"><img src="/wp-content/themes/muxiulin/images/banner/toptop1.gif" alt="木秀林" width="710" height="100" /></a>'),
	...
	array(	"name" => "输入正文右上角广告代码",
            ...
            "id" => $shortname."_adrc",
            "type" => "textarea",
            "std" => '<a href="http://www.muxiulin.com/" target="_blank"><img src="/wp-content/themes/muxiulin/images/banner/quebanban2.jpg" alt="木秀林" width="271" height="170" /></a>'),
...
add_theme_page($themename." Options", "muxiulin主题设置", 'edit_themes', basename(__FILE__), 'mytheme_admin');
}
...
<p>当前使用主题: muxiulin | 设计者: <a href="http://www.muxiulin.com" target="_blank">木秀林网</a></p> 
<?php
...
<?php break; }} ?>
<span class="show_id">
<p><strong>木秀林网提示：</strong></p>
<p>首次使用muxiulin主题，必须按照您的需要，设置好每个选项，并全都保存一次，否则可能会错位！</p>
</span>
