...
//广告设置
	...
	array(	"name" => "输入首页(上)广告代码",
            ...
            "id" => $shortname."_top_c",
            "type" => "textarea",
            "std" => '<a href="http://www.chepin3.com/" target="_blank"><img src="/wp-content/themes/chepin/images/banner/toptop1.gif" alt="车品三省网" width="710" height="100" /></a>'),
	...
	array(	"name" => "输入正文右上角广告代码",
            ...
            "id" => $shortname."_adrc",
            "type" => "textarea",
            "std" => '<a href="http://www.chepin3.com/" target="_blank"><img src="/wp-content/themes/chepin/images/banner/quebanban2.jpg" alt="车品三省网" width="271" height="170" /></a>'),
...
add_theme_page($themename." Options", "车品三省主题设置", 'edit_themes', basename(__FILE__), 'mytheme_admin');
}
...
<p>当前使用主题: 车品三省网 | 设计者: <a href="http://www.chepin3.com" target="_blank">车品三省网</a></p> 
<?php
...
<?php break; }} ?>
<span class="show_id">
<p><strong>车品三省网提示：</strong></p>
<p>首次使用车品三省主题，必须按照您的需要，设置好每个选项，并全都保存一次，否则可能会错位！</p>
</span>
