   ...
   ?>
    ...
    <form method="POST" action="" style="width:400px;height:420px; border:1px #ddd solid;margin:30px;">
		...
		<p style=" margin-left:20px;float:left;" >		 
		 默认玫红配色：<br/> <img src="/wp-content/themes/swiftlet/images/banner/red.jpg" alt="时美网" width="120" height="30"/></p><br/>
		 <p style=" margin-left:20px;float:left;" >	
		 大方黑色基调<br/> <img src="/wp-content/themes/swiftlet/images/banner/black.jpg" alt="时美网" width="120" height="30"/></p><br/>
		 <p style=" margin-left:20px;float:left;" >	
		 稳重深蓝基调<br/> <img src="/wp-content/themes/swiftlet/images/banner/blue0.jpg" alt="时美网" width="120" height="30"/></p><br/>
		 <p style=" margin-left:20px;float:left;" >	
		 悠闲浅蓝基调<br/> <img src="/wp-content/themes/swiftlet/images/banner/blue1.jpg" alt="时美网" width="120" height="30"/></p><br/>
		 <p style=" margin-left:20px;float:left;" >	
		 可爱粉红基调<br/> <img src="/wp-content/themes/swiftlet/images/banner/pink.jpg" alt="时美网" width="120" height="30"/></p><br/>
		 <p style=" margin-left:20px;float:left;" >	
		 清新竹绿基调<br/> <img src="/wp-content/themes/swiftlet/images/banner/green.jpg" alt="时美网" width="120" height="30"/></p><br/>
		 <p style=" margin-left:20px;float:left;" >	
		 尊贵紫色基调<br/> <img src="/wp-content/themes/swiftlet/images/banner/purple.jpg" alt="时美网" width="120" height="30"/>
		</p>  
