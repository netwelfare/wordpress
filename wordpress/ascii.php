...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/tools/ascii/ascii_files/style.css" type="text/css">
 	...
 	<div id="art_container clearfix">
                ...
                <div class="panel">
                    ...
                    <div class="mcon center">
                        ...
                        <form name="characterCode">
                            <center>
                                输入一个待查字符:
                                <input type="text" name="character" size="6" style="font-size:24px">
                    ...
                    <div class="mcon">
                        ...
                        <p>
                            　　ASCII（American Standard Code for Information Interchange，美国信息互换标准代码，ASCⅡ）是基于拉丁字母的一套电脑编码系统。它主要用于显示现代英语和其他西欧语言。它是现今最通用的
                        ...
                        <hr size="1" />
                        <h3 class="f14 p8 center pink">
                            ASCII控制字符
                        </h3>
                        <table class="bx" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <thead>
                                <tr valign="bottom">
                                    <th>
                                        二进制
        ...
        <script language="javascript">
            function showKeyCode() {
                ...
                var msg = "<h1>\" " + character + "\" 对应的ASCII码值为: " + code + "</h1> ----金丝燕网提供----";
                document.all.preview.innerHTML = msg
            }
        </script>
